...
- **Passo 2** - Modelo de Gráfico Prometheus
 ...
 Acessar link Grafana para baixar modelo de Dashboard **https://grafana.com/grafana/dashboards/**
 Buscar a opção: **Prometheus 2.0 Overview** e Copiar ID do Dashboard **3662**
 Clicar no menu em Dashboard , clicar em **New** e escolher a segunda opção **Importar Dashboard**
 Informe o ID **3662** e clique em **Load**, selecione em DS_THEMIS **prometheus** e clique em Import.
